<div class="card">
    <div class="card-body">
        <h4> Генеральный директор: {{$company->manager->manager}}</h4>
        <hr>
            ...
            <div class="card ">
                ...
                <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                    <div class="card-body">
                        @if(!$managerComments)
                        @else
                            @foreach($managerComments as $comment)
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Отзывы о директоре</label>
                            <input name="manager" type="text" class="form-control" id="exampleInputEmail1">
                        </div>
