<div class="card">
    <div class="card-body">
        <h4> Комментарии о компании в целом </h4>
        <hr>
            ...
            <div class="card ">
                ...
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                    <div class="card-body">
                        @if(!$aboutComments)
                        @else
                            @foreach($aboutComments as $comment)
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Отзывы о компании в целом</label>
                            <input name="about" type="text" class="form-control" id="exampleInputEmail1">
                        </div>
