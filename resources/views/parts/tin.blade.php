            ...
            <div class="card ">
                <div class="card-header" id="headingTwo">
                    <h5 class="mb-0">
                        <button class="btn btn-link btn-block collapsed btn-main" type="button" data-toggle="collapse"
                                data-target="#collapseTwo5" aria-expanded="false" aria-controls="collapseTwo">
                ...
                <div id="collapseTwo5" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                    <div class="card-body">
                        @if(!$tinComments)
                        @else
                            @foreach($tinComments as $comment)
                        ...
                        <div class="form-group">
                            ...
                            <input name="tin" type="text" class="form-control" id="exampleInputEmail1">
                        </div>
